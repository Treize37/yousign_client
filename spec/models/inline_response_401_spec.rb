...
# Unit tests for YousignClient::InlineResponse401
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse401' do
  before do
    # run before each test
    @instance = YousignClient::InlineResponse401.new
  end
  ...
  describe 'test an instance of InlineResponse401' do
    it 'should create an instance of InlineResponse401' do
      expect(@instance).to be_instance_of(YousignClient::InlineResponse401)
    end
  end
