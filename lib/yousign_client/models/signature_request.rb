  ...
  class SignatureRequest
    ...
    def self.openapi_types
      {
        ...
        :'created_at' => :'Object',
        :'ordered_signers' => :'Object',
        :'reminder_settings' => :'Object',
        :'timezone' => :'Object',
        :'email_custom_note' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `YousignClient::SignatureRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `YousignClient::SignatureRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @reminder_settings.nil?
        invalid_properties.push('invalid value for "reminder_settings", reminder_settings cannot be nil.')
      end
      ...
      if @email_custom_note.nil?
        invalid_properties.push('invalid value for "email_custom_note", email_custom_note cannot be nil.')
      end
      ...
      if @branding_id.nil?
        invalid_properties.push('invalid value for "branding_id", branding_id cannot be nil.')
      end

      if @custom_experience_id.nil?
        invalid_properties.push('invalid value for "custom_experience_id", custom_experience_id cannot be nil.')
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('Object', ['draft', 'ongoing', 'done', 'deleted', 'expired', 'canceled', 'approval', 'rejected'])
      return false unless status_validator.valid?(@status)
      return false if @name.nil?
      return false if @delivery_mode.nil?
      delivery_mode_validator = EnumAttributeValidator.new('Object', ['email', 'none'])
      ...
      return false if @email_custom_note.nil?
      return false if @expiration_date.nil?
      return false if @source.nil?
      source_validator = EnumAttributeValidator.new('Object', ['app', 'public_api', 'connector_hubspot_api', 'connector_salesforce_api', 'connector_google_api', 'connector_zapier_api'])
      return false unless source_validator.valid?(@source)
      return false if @signers.nil?
      return false if @documents.nil?
      return false if @sender.nil?
      return false if @external_id.nil?
      return false if @branding_id.nil?
      return false if @custom_experience_id.nil?
      true
    end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['draft', 'ongoing', 'done', 'deleted', 'expired', 'canceled', 'approval', 'rejected'])
    ...
    def delivery_mode=(delivery_mode)
      validator = EnumAttributeValidator.new('Object', ['email', 'none'])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('Object', ['app', 'public_api', 'connector_hubspot_api', 'connector_salesforce_api', 'connector_google_api', 'connector_zapier_api'])
    ...
    def hash
      [id, status, name, delivery_mode, created_at, ordered_signers, reminder_settings, timezone, email_custom_note, expiration_date, source, signers, approvers, documents, sender, external_id, branding_id, custom_experience_id, workspace_id].hash
    end
