...
module YousignClient
  # Signer with signature link
  class SignerWithSignatureLink
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'signature_link_expiration_date' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `YousignClient::SignerWithSignatureLink` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `YousignClient::SignerWithSignatureLink`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @signature_link_expiration_date.nil?
        invalid_properties.push('invalid value for "signature_link_expiration_date", signature_link_expiration_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @signature_link_expiration_date.nil?
    ...
    def hash
      [id, info, status, fields, signature_level, signature_authentication_mode, signature_link, signature_link_expiration_date, signature_image_preview, redirect_urls, custom_text].hash
    end
